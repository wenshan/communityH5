(function(g, fn) {
        ...
        setTimeout(
          function() {
            ...
            var transform3d =
                ...
                'px,0px)',
              transform2d =
                'scale(' + zoomFactor + ', ' + zoomFactor + ') ' + 'translate(' + offsetX + 'px,' + offsetY + 'px)',
  ...
  Pdfh5.prototype = {
    init: function(options) {
      ...
      if (
        this.options.logo &&
        Object.prototype.toString.call(this.options.logo) === '[object Object]' &&
        this.options.logo.src
      ) {
    ...
    renderCanvas: function(page, viewport, pageNum, num, container, options) {
      ...
      if (options.logo) {
        context.drawImage(
          self.options.logo.img,
          self.options.logo.x * self.options.scale,
          self.options.logo.y * self.options.scale,
          self.options.logo.width * self.options.scale,
          self.options.logo.height * self.options.scale
        );
      }
